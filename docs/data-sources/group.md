...
# Data Source: groupmanager_group

Gets information about an owned Azure Active Directory group.

## API Permissions

The following API permissions are required in order to use this data source.

When authenticated with a service principal, this data source requires the following application roles: `Group.Create`, `GroupMembers.Read.All` and `User.Read.All`

## Example Usage (by Group Display Name)

```terraform
data "groupmanager_group" "example" {
